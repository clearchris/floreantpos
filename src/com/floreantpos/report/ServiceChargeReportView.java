...
public class ServiceChargeReportView extends TransparentPanel {
    private JButton btnGo = new JButton(POSConstants.GO);
    private JXDatePicker fromDatePicker = UiUtil.getCurrentMonthStart();
    private JXDatePicker toDatePicker = UiUtil.getCurrentMonthEnd();
    private JPanel reportContainer;

    public ServiceChargeReportView() {
        ...
        btnGo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    POSMessageDialog.showError(ServiceChargeReportView.this, POSConstants.ERROR_MESSAGE, e1);
                }
            }
        });
    }
    ...
    private void viewReport() {
        ...
        List<ServiceChargeReportData> findServiceCharges = dao.createServiceChargeReport(fromDate, toDate, null);

        try {
            JasperReport report = ReportUtil.getReport("ServiceChargesReport"); //$NON-NLS-1$
            ...
            ServiceChargeReportModel reportModel = new ServiceChargeReportModel();
            reportModel.setRows(findServiceCharges);
